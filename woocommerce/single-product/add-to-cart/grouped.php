...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	<div class="woocommerce-grouped-product-list group_table">
			...
			foreach ( $grouped_products as $grouped_product_child ) {
				...
				echo '<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', $grouped_product_child->get_permalink(), $grouped_product_child->get_id() ) ) . '" id="product-' . esc_attr( $grouped_product_child->get_id() ) . '" class="woocommerce-grouped-product-list-item ' . esc_attr( implode( ' ', wc_get_product_class( '', $grouped_product_child ) ) ) . '">';
				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					switch ( $column_id ) {						
						case 'label':
							...
							$value .= '<span class="product_name">' . $product_name . '</span>';
							$value .= $repair_name;							
