...
Roxtar is fast, lightweight, responsive and super flexible WooCommerce theme built with SEO, speed, and usability in mind.
...
Roxtar is compatible with all well-coded plugins, including major ones like WooCommerce, OrbitFox, Yoast, BuddyPress, bbPress, etc.
Learn more about the theme and ready to import demo sites at https://roxtar.com
...
= Is Roxtar Free? =
Yes! Roxtar is a free theme, and always will be.

= Does Roxtar have a pro version? =
It does! Roxtar has a premium plugin which extends the available options in the theme.

You can learn more about [here](https://roxtar.com/).

= Where can I find documentation? =
Roxtar has extensive documentation you can find [here](https://roxtar.com/docs).

= Do you offer support? =
Definitely. We offer support for the free theme in the WordPress theme forum.

Premium customers have access to our very own [ticket](https://roxtar.com/contact).
...
= Does Roxtar have any widget areas? =
It has up to 6 widget areas which you can add widgets to in Appearance > Widgets.

== Copyright ==

Roxtar WordPress Theme, Copyright 2018 roxtar.com
Roxtar is distributed under the terms of the GNU GPL

Roxtar bundles the following third-party resources:
