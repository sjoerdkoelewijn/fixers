...
if ( ! class_exists( 'SKDD' ) ) {
	...
	class SKDD {
		...
		public function SKDD_body_classes( $classes ) {
			...
			// Blog page layout.
			if ( ( SKDD_is_blog() || is_search() || SKDD_is_cpt() ) && ! is_singular( 'post' ) && ! is_singular( 'portfolio' ) && ! is_singular( 'team' ) && ! is_singular( 'services' ) && ! is_singular( 'location' ) && ! is_singular( 'support' ) && ! is_singular( 'knowledge' ) ) {
