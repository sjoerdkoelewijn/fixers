...
//$wp_customize->get_control( 'background_color' )->section  = 'roxtar_color';
//$wp_customize->get_control( 'background_color' )->priority = 1;

// Change background image section title & priority.
//$wp_customize->get_section( 'background_image' )->panel    = 'roxtar_layout';
//$wp_customize->get_section( 'background_image' )->title    = __( 'Site Container', 'roxtar' );
